    ...
    <div class="cd-faq-items">
        <ul id="basics" class="cd-faq-group">
            ...
            <?php
                ...
                global $post;
                $args = array( 'numberposts' => 16, 'category_name' => 'faqs-general-questions' );
        ...
        <ul id="mobile" class="cd-faq-group">
            <li class="cd-faq-title"><h2>USSD Service</h2></li>
            <?php
                $our_doctors_slug = get_option('our_doctors_slug');
                global $post;
                $args = array( 'numberposts' => 16, 'category_name' => 'faqs-ussd-service' );
                $posts = get_posts( $args );
                foreach( $posts as $post ): setup_postdata($post); 
                $postid = get_the_ID();
        ...
        <ul id="account" class="cd-faq-group">
            <li class="cd-faq-title"><h2>Smartphone Service</h2></li>
            <?php
                $our_doctors_slug = get_option('our_doctors_slug');
                global $post;
                $args = array( 'numberposts' => 16, 'category_name' => 'faqs-smartphone-service' );
                $posts = get_posts( $args );
                foreach( $posts as $post ): setup_postdata($post); 
                $postid = get_the_ID();
