...
<header>
    <div class="header-content">
        <div class="header-content-inner">
            <h2 style="color:#fff; letter-spacing: 4px;">
                Buri wese afite ubuvuzi<br> bw'umwihariko 
                <?php // print get_option('homepage_title'); ?>
            </h2>
            <h3 style="color:#fff;font-size: 18px;margin-top: 40px;margin-bottom: 40px;">
            n'abaganga b'inzobere  mu  biganza bye,<br> igihe ubikeneye
            <?php // print get_option('homepage_description'); ?>
            </h3>
            ...
            <h2 style="color:#fff; letter-spacing: 4px;">Dial *811# to register with babyl</h2>
        </div>
    </div>
</header>
<div class="container text-center">
    ...
    <div class="section-title-area col-lg-6"><br>
        <h2 class="section-title" style="/*color: #000;*/font-size: 40px;letter-spacing: 1px;">
        Horana Ubuzima bwiza 
        <?php // print get_option('homepage_sec_2_title'); ?>
        </h2><hr class="style-four"> 
        <p class="text-justify" style="font-family:Varela Round;">
        babyl itanga uburyo bwo kwisuzuma ukoresheje ikoranabunga 
        rigezweho hamwe n'abaganga binzobere mu buvuzi, birahendutse 
        kandi birororshye kutugeraho ahantu hose.<br><br>

        Ubuvuzi bwa babyl bwatangijwe ku mugaragaro 2014 muri London 
        bakorera mu Bwongereza,Ireland no mu Rwanda. Uburyo twakira 
        abatugana,Ubuvuzi bwa babyl buriho gukemura<br><br>

        Ubu,50% bya batuye isi ntibashoboye kugera ku buvuzi. 
        Ubuvuzi bwa babyl nibwo bwonyine bukuraho icyo cyuho 
        ukoresheje telefone. Ubuvuzi bwa babyl ryubatse ihuriro ryikorana


        <?php // print get_option('homepage_sec_2_desc'); ?>
        </p> 
    </div>
    <div class="section-title-area col-lg-6 vd"><br> 
        <p>
            <iframe src="https://www.youtube.com/embed/TLY6Yf0i5HY?rel=0" width="690" height="388" frameborder="0" allowfullscreen="allowfullscreen"></iframe>
        </p>
                    <?php
                        /*
                        // global $post;
        ...
        <div id="services" class="scroll_target" style="margin-top: -80px"></div>
            ...
            <div class="container">
                ...
                <div class="section-title-area">
                    ...
                    Servise zacu
                    <?php // print get_option('homepage_sec_4_title'); ?>
                    </h2><hr class="style-four">
                ...
                <div class="row">
                    <div class="col-lg-4 col-sm-6">
                        ...
                        <div class="btm">
                            <h3 class="btm-title">
                            Fata gahunda yo kwivuza
                            <?php // print get_option('homepage_serv_1_title'); ?>
                            </h3>
                            <p class="text-center">
                            Biroroshye gufata gahunda yo kwivuza muri babyl. 
                            Kanda *811# muri telefone yawe cyangwa ushyiremo 
                            application ya Appstore ( kuri telefone za iphone) 
                            hamwe na Google play ( kuri telefone za Android).
                            <?php // print get_option('homepage_serv_1_desc'); ?>
                            </p><br><br><br>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        ...
                        <div class="btm">
                            <h3 class="btm-title">
                            Impapuro zerekana uko uhagaze
                            <?php // print get_option('homepage_serv_2_title'); ?>
                            </h3>
                            <p class="text-center">
                            Abaganga bacu bakoherereza ubutumwa kuri telefone 
                            bwuko ubuzima bwawe buhagaze. Ushobora gusura zimwe 
                            muri farumasi zo mu mujyi wa kigali bakagusuzuma imbonankubone.
                            <?php // print get_option('homepage_serv_2_desc'); ?>
                            </p><br>
                            <a href="<?php print get_option('homepage_serv_2_btn_link'); ?>" style="margin-left: 18%;" class="button bt1"><i class="fa fa-chevron-right"></i> 
                            Urutonde rwa pharamasi
                            <?php // print get_option('homepage_serv_2_btn_title'); ?>
                            </a>
                        </div>
                        <!-- <hr> -->
                    </div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        ...
                        <div class="btm">
                            <h3 class="btm-title">
                            Umwihariko mu buvuzi
                            <?php // print get_option('homepage_serv_3_title'); ?>
                            </h3>
                            <p class="text-center">
                            Bably ibiste amakuru y'ubuzima y'ahashize n'agezweho 
                            by' Umwihariko mu buvuzi  bwawe. ukoresheje umubare 
                            wiganga. kanda *811# usabe gahunda.
                            <?php // print get_option('homepage_serv_3_desc'); ?>
                            </p><br><br><br><br>
                ...
                <div class="row">
                    <div class="text-center"><br>
                        ...
                        “
                        babyl itumanaho rya mbere kwisi ryizewe mu byubuvuzi hakoreshejwe telephone
                        <?php // print get_option('homepage_quote'); ?>
                        ”
                        </h3<br>
                        <hr class="style-eight" style="display:none;"><hr class="style-eight-second" style="display:none;"><br>
                    </div>
                        ...
                        <div class="col-sm-8">
                             <div class="row">
                                <div class="col-xs-12 col-sm-12">
                                    <p>
                                        “Biroroshye kugera ku Muganga mwiza 
                                        nkoresheje telephone yanjye nibyo bintu 
                                        byiza byabaye mu ikoranabuhanga mu Rwanda.”
                                        <br>
                                        <br>
                                        <i>VU,Kigali</i>
                                    </p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                             <div class="row">
                                <div class="col-xs-12 col-sm-12">
                                    <p>
                                        “Mererwa neza kumenya ko nabona inama 
                                        z'ubuzima ntarinze gutonda umurongo ku bitaro.”
                                        <br>
                                        <br>
                                        <i>DN,Kigali</i>
                                    </p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                             <div class="row">
                                <div class="col-xs-12 col-sm-12">
                                    <p>
                                        “babyl nu buryo bushya bwo kwivuza butanga umusaruro 
                                        ukoresheje igihe gito. Nkunda iyi servise.”
                                        <br>
                                        <br>
                                        <i>DN,Kigali</i>
                                    </p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                             <div class="row">
                                <div class="col-xs-12 col-sm-12">
                                    <p>
                                        “Ni servise nziza kandi izafasha abantu 
                                        cyane cyane abantu batabona umwanya wo 
                                        gutonda umurongo kwa muganga.”
                                        <br>
                                        <br>
                                        <i>MB,Kigali</i>
                                    </p>
    ...
    <section class="section_doctors">
        ...
        <div class="container">
            <div class="section-title-area">
                <h2 class="section-title">
                Abaganga bacu
                <?php // print get_option('our_doctors'); ?>
                </h2><hr class="style-four">
                <p class="text-justify"><?php print get_option('our_doctors_desc'); ?></p>
            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-4  ">
                                <div class="panel panel-default">
                                    <div class="panel-body panel-bbln">
                                        <h3 class="text-center">
                                        Intego yacu
                                        <?php // print get_option('homepage_vision_mission'); ?>
                                        </h3>
                                        <img class="img img-responsive" src="<?php print get_option('homepage_vision_mission_img'); ?>"><hr class="style-four">
                                        <p class="text-center">
                                        Intego y'ubuvuzi bwa babyl nu gushyiraho 
                                        ubuvuzi buhuriweho kwisi yose kandi 
                                        buhendutse kuri burumwe wese aho ari hose.
                                        <?php print get_option('homepage_vision_mission_desc'); ?>
                                        </p><br>
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-4  ">
                                <div class="panel panel-default">
                                    <div class="panel-body panel-bbln">
                                        <h3 class="text-center">
                                        Itsinda ryacu
                                        <?php // print get_option('homepage_our_team'); ?>
                                        </h3>
                                        <img class="img img-responsive" src="<?php print get_option('homepage_our_team_img'); ?>"><hr class="style-four">
                                        <p class="text-center">
                                        Hura n'itsinda rishinzwe kwita kuri servise zubuzima.
                                        <?php // print get_option('homepage_our_team_desc'); ?>
                                        </p><br><br><br><br><br>
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-4 ">
                                <div class="panel panel-default">
                                    <div class="panel-body panel-bbln">
                                        ...
                                        <?php // print get_option('homepage_our_partners'); ?>
                                        </h3>
                                        <img class="img img-responsive" src="<?php print get_option('homepage_our_partners_img'); ?>"><hr class="style-four">
                                        <p class="text-center">
                                        Abafatanya bikorwa ba babyl na bakozi bayo,
                                        batanga servise nziza zu buvuzi.
                                        <?php // print get_option('homepage_our_partners_desc'); ?>
                                        </p><br><br><br><br><br>
