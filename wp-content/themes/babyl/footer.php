            ...
            <div class="">
                <div class="col-md-4 col-sm-6">
                    ...
                    <ul class="list-inline social-buttons">
                        <li><a href="https://web.facebook.com/babylrwanda/?ref=aymt_homepage_panel" target="_blank"><i class="fa fa-2x fa-facebook"></i></a>
                        </li>
                        <!-- <li><a href="#" target="_blank"><i class="fa fa-2x fa-instagram"></i></a>
                        </li> -->
                        <li><a href="https://twitter.com/babylrwanda" target="_blank"><i class="fa fa-2x fa-twitter"></i></a>
                        </li>
               ...
               <div class="col-md-4 col-sm-6">
                   <div class="timeline-heading">
                    ...
                    <ul class="quicklinks">
                        <li><a href="<?php echo get_home_url(); ?>/news/" title="news">News</a></li>
                        <li><a href="<?php echo get_home_url(); ?>/careers/" title="Careers">Careers</a></li>
                        <li><a href="<?php echo get_home_url(); ?>/terms/" title="terms">Terms in English</a></li>
                        <li><a href="<?php echo get_home_url(); ?>/terms-kin/" title="terms">Terms in Kinyarwanda</a></li>
                        <li><a href="<?php echo get_home_url(); ?>/privacy/" title="Privacy policy">Privacy policy</a></li>
                        <li><a href="<?php echo get_home_url(); ?>/feedback/" title="Your Feedback">Your Feedback</a></li>
<!--
...
-->
               <div class="col-md-4 col-sm-6">
                   ...
                   <ul class="quicklinks">
                        <li><a href="<?php echo get_home_url(); ?>/faqs/" title="faqs">FAQ in English</a></li>
                        <li><a href="<?php echo get_home_url(); ?>/faqs-kin-2/" title="faqs">FAQ in Kinyarwanda</a></li>
                        <li><a href="<?php echo get_home_url(); ?>/voucher/" title="Voucher">Voucher</a></li>
                        <li><a href="<?php echo get_home_url(); ?>/treat/" title="What we treat">What we treat</a></li>
                        <li><a href="<?php echo get_home_url(); ?>/pharmacies/" title="Pharmacies">Pharmacies</a></li>
                        <!-- <li><a href="<?php echo get_home_url(); ?>/hospitals/" title="faqs">Hospitals</a></li> -->
